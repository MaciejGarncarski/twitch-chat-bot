...
export const en: TranslationSchema = {
  ...
  player: {
    ...
    shuffle: "Shuffle",
    clearAll: "Clear All",
    confirmSkip: "Skip song?",
    confirmSkipDescription: "The current song will be skipped.",
    confirmShuffle: "Shuffle queue?",
    confirmShuffleDescription: "The queue order will be randomized.",
    confirmClearAll: "Clear queue?",
    confirmClearAllDescription: "All songs will be removed from the queue.",
    seekForward: "+5 sec.",
    seekBackward: "-5 sec.",
    mute: "Mute",
    unmute: "Unmute",
